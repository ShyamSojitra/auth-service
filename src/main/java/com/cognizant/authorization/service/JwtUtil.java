...
public class JwtUtil {
	...
	/**
	 * Token is generated for 15 mins The signature is used to verify the message
	...
	private String createToken(Map<String, Object> claims, String subject) {
		...
		String token = Jwts.builder().setClaims(claims).setSubject(subject)
				...
				.setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 30 / 2))// token for 15 mins
